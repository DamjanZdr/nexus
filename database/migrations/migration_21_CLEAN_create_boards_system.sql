-- Migration: CLEAN Create Boards System (Drops existing tables first)
-- Date: 2025-01-08
-- Description: Drops and recreates board system tables
-- WARNING: This will DELETE ALL EXISTING BOARD DATA

-- Drop existing tables in correct order (respecting foreign keys)
DROP TABLE IF EXISTS card_assignees CASCADE;
DROP TABLE IF EXISTS cards CASCADE;
DROP TABLE IF EXISTS board_statuses CASCADE;
DROP TABLE IF EXISTS board_access CASCADE;
DROP TABLE IF EXISTS boards CASCADE;

-- Now run the rest of migration_21_create_boards_system.sql
-- Copy all content from that file starting from the CREATE TABLE boards line
-- ============================================
-- BOARDS TABLE
-- ============================================
